...
<template>
  <div>
        ...
        <div class="main-sidebar sidebar-style-2">
          <aside id="sidebar-wrapper">
            <div class="sidebar-brand">
              <a href="index.html">Putt Admin</a>
            </div>
            ...
            <ul class="sidebar-menu">
              <li class="active">
                <a class="nav-link" href="credits.html" title="Pages"
                  ><i class="fas fa-pencil-ruler"></i> <span>Pages</span></a
                >
              </li>
            </ul>
    ...
    <div class="builder-disable">
      <i class="icon ion-alert-circled"></i>
      <p>Builder is not available on mobile</p>
    </div>
  </div>
</template>
